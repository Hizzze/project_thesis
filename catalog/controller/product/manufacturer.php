...
class ControllerProductManufacturer extends Controller
{
    ...
    public function info()
    {
        ...
        if (false != false && $manufacturer_info) {
            ...
            foreach ($categories_1 as $category_1) {
                ...
                foreach ($categories_2 as $category_2) {
                    ...
                    foreach ($categories_3 as $category_3) {
                        $level_3_data[] = array(
                            ...
                            'count' => $this->model_catalog_product->getTotalProducts(array_merge($filter_data, array(
                                'filter_category_id' => $category_3['category_id']
                            ))),
                            'link' => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $manufacturer_id . '&category_id=' . $category_3['category_id']),
                    ...
                    $level_2_data[] = array(
                        ...
                        'link' => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $manufacturer_id . '&category_id=' . $category_2['category_id']),
                ...
                $data['categories'][] = array(
                    ...
                    'link' => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $manufacturer_id . '&category_id=' . $category_1['category_id']),
