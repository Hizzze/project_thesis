...
class ControllerStartupStartup extends Controller {
	public function index() {
        ...
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "translation WHERE store_id = '" . (int)$this->config->get('config_store_id') . "' AND language_id = '" . (int)$languages[$code]['language_id'] . "'");

        foreach( $query->rows as $row ) {
            $language->set($row['key'], $row['value']);
        };
