        ...
        if ($news_list) {
            ...
            foreach ($news_list as $result) {
                ...
                $data['news_list'][] = array(
                    ...
                    'image'			=> $image,
                    'description' => (utf8_strlen(strip_tags(html_entity_decode($result['description'], ENT_QUOTES))) > $news_setting['description_limit'] ? utf8_substr(strip_tags(html_entity_decode($result['description'], ENT_QUOTES)), 0, $news_setting['description_limit']) . '...' : strip_tags(html_entity_decode($result['description'], ENT_QUOTES))),
                    'view' 			=> $this->url->link('information/news/info', 'news_id=' . $result['news_id']),
