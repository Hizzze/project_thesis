...
class ControllerCheckoutGuest extends Controller {
	...
	public function save() {
		...
		if (!$json) {
			...
			if ($this->request->post['email'] && ((utf8_strlen(trim($this->request->post['address_1'])) < 3) || (utf8_strlen(trim($this->request->post['address_1'])) > 128))) {
				$json['error']['address_1'] = $this->language->get('error_address_1');
			}

			if ($this->request->post['email'] && ((utf8_strlen(trim($this->request->post['city'])) < 2) || (utf8_strlen(trim($this->request->post['city'])) > 128))) {
