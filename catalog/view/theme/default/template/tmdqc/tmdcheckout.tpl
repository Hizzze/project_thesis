...
<?php } ?>
<div id="quick-checkout" class="container checkout">
...
$(document).ready(function(){
	var html = '<div id="final-button">';
			...
			html += '<input type="button" value="<?php echo $button_order; ?>" id="tmdbuttonorder" class="pay_btn" data-loading-text="<?php echo $text_loading; ?>" />';
			html += '</div>';
			html += '</div>';
			html += '</div>';
