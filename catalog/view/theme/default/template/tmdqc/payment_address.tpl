		...
		<div class="form-group">
			<label class="control-label" for="input-payment-address"><?php echo $entry_selectaddress; ?></label>
				<select name="address_id" class="form-control">
					...
					<option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['firstname']; ?> <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?></option>
					<?php } else { ?>
					<option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?></option>
					<?php } ?>
					<?php } ?>
