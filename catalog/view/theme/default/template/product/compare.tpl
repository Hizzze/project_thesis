...
<div class="container compare-page">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="mob-visible compare-control visible-xs-block">
        <p>Максимальное число активных товаров: 2</p>
        <?php if ($products) { ?>
            <?php foreach ($products as $product) { ?>
                <div class="compare-control__item">
                  <i></i>
...
<!--
        ...
        <tr>
          ...
          <?php foreach ($products as $product) { ?>
          <td>
            <div class="compare-btn-buy">
             <input type="button" value="<?php echo $button_cart; ?>" class="buy" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" />
            ...
            <a href="<?php echo $product['remove']; ?>" class="compare-delete"></a>
          <?php } ?>
        </tr>
      </table>
      </div>
      ...
      <div class="buttons">
        <div class="pull-right"><a href="<?php echo $continue; ?>" class="buy_reverse"><?php echo $button_continue; ?></a></div>
      </div>
      <?php } ?>
