...
<div class="container" id="reg_page">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div class="login_canvas reg_canv clearfix">
      <div class="reg_form_wrapper clearfix"> 
        <h1 class="title"><?php echo $heading_title; ?></h1>
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          <fieldset id="account" class="col-lg-12">
            ...
            <div class="required">
              ...
              <div>
                <input type="email" name="email" value="<?php echo $email; ?>" placeholder="" id="input-email" class="form-control" />
                <?php if ($error_email) { ?>
            ...
            <div class="required">
              ...
              <div>
                <input type="tel" name="telephone" value="<?php echo $telephone; ?>" placeholder="" id="input-telephone" class="form-control" />
          ...
          <fieldset id="address" class="col-lg-12">
            <legend><?php echo $text_your_address; ?></legend>
            <div class="required">
              <label class="control-label" for="input-address-1"><?php echo $entry_address_1; ?></label>
              <div>
                <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="" id="input-address-1" class="form-control" />
          ...
          <fieldset class="reg_pass col-lg-12">
          ...
          <div class="buttons col-sm-12">
            <div class="pull-right"><?php echo $text_agree; ?>
              ...
              <?php } ?>
              &nbsp;
              <input type="submit" value="<?php echo $button_continue; ?>" class="buy" />
            </div>
          </div>
          <?php } else { ?>
          <div class="buttons col-sm-12">
