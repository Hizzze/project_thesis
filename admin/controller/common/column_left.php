...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/menu')) {
                $catalog[] = array(
                    'name'	   => 'Основное укр меню',
                    'href'     => $this->url->link('catalog/menu/ua', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'catalog/menu')) {
                $catalog[] = array(
                    'name'	   => 'Верхнее меню',
                    'href'     => $this->url->link('catalog/menu/top', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'catalog/menu')) {
                $catalog[] = array(
                    'name'	   => 'Верхнее укр меню',
                    'href'     => $this->url->link('catalog/menu/top_ua', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'catalog/menu')) {
                $catalog[] = array(
                    'name'	   => 'Мобильное меню',
                    'href'     => $this->url->link('catalog/menu/mobile', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'catalog/menu')) {
                $catalog[] = array(
                    'name'	   => 'Мобильное укр меню',
                    'href'     => $this->url->link('catalog/menu/mobile_ua', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
      ...
      // OCFilter start
            ...
            if ($this->user->hasPermission('access', 'catalog/ocfilter')) {
                $catalog[] = array(
                    ...
                    'href'     => $this->url->link('catalog/ocfilter/page', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
            if ($this->user->hasPermission('access', 'extension/module/sets_manage')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_sets_manage'),
                    'href'     => $this->url->link('extension/module/sets_manage', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
		  // OCFilter end
...
//			}
			...
			*/
            ...
            if ($this->user->hasPermission('access', 'extension/module/html')) {
                $design[] = array(
                    'name' => 'Footer',
                    'href' => $this->url->link('extension/module/html', 'module_id=37&token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
            if ($this->user->hasPermission('access', 'extension/module/html')) {
                $design[] = array(
                    'name' => 'Home',
                    'href' => $this->url->link('extension/module/html', 'module_id=38&token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
			/*
