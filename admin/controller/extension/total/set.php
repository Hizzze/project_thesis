...
class ControllerExtensionTotalSet extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/total/set', 'token=' . $this->session->data['token'], true)
        );

        $data['action'] = $this->url->link('extension/total/set', 'token=' . $this->session->data['token'], true);
        ...
        if (isset($this->request->post['set_status'])) {
            $data['set_status'] = $this->request->post['set_status'];
        } else {
            $data['set_status'] = $this->config->get('set_status');
        }
