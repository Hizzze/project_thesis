...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
        ...
        $data['seo_category_meta_title'] = $this->language->get('seo_category_meta_title');
        $data['seo_category_meta_description'] = $this->language->get('seo_category_meta_description');
        $data['seo_category_meta_keywords'] = $this->language->get('seo_category_meta_keywords');
