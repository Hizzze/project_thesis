...
class ControllerCatalogProduct extends Controller {
    ...
    public function save() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            $this->model_catalog_product->saveProduct($this->request->post['product_id'], $this->request->post);
        }
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_catalog_product->addProduct(array_merge($this->request->post, ['shipping' => 1]));
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_catalog_product->editProduct($this->request->get['product_id'], array_merge($this->request->post, ['shipping' => 1]));
    ...
    protected function getList() {
        ...
        $results2 = $this->model_localisation_currency->getCurrencies();
        $data['currentCurrency'] = array();
        ...
        foreach ($results as $result) {
            ...
            $arr = array(
                ...
                'currency' => $this->currency->get(mb_strtolower($result['currency'])),
                'image' => $image,
                'name' => $result['name'],
                'model' => $result['model'],
                'sku' => $result['sku'],
            ...
            if (!$result['currency'] || !$arr['currency']['value']) {
                $arr['currency'] = $this->currency->get($this->config->get('config_currency'));
            }
    ...
    protected function getForm() {
        ...
        $data['entry_manufacturer'] = $this->language->get('entry_manufacturer');
        $data['entry_category2'] = $this->language->get('entry_category2');
        ...
        $data['seo_product_meta_title'] = $this->language->get('seo_product_meta_title');
        $data['seo_product_meta_description'] = $this->language->get('seo_product_meta_description');
        $data['seo_product_meta_keywords'] = $this->language->get('seo_product_meta_keywords');
        ...
        if(!empty($product_info)) {
            $data['product_link'] = '/index.php?product_id=' . $product_info['product_id'];
        } else {
            $data['product_link'] = '';
        }
        ...
        if (!empty($product_info)) {
            $data['isbn'] = HTTP_FILES . $product_info['isbn'];
        } else {
            $data['isbn'] = '';
        }
        ...
        if (isset($this->request->post['currency'])) {
            $data['currency'] = $this->currency->get($this->request->post['currency']);
        } elseif (!empty($product_info) && $product_info['currency']) {
            $data['currency'] = $this->currency->get(mb_strtolower($product_info['currency']));
        } else {
            $data['currency'] = $this->currency->get($this->config->get('config_currency'));
        }
        ...
        if (isset($this->request->post['category2_id'])) {
            $data['category2_id'] = $this->request->post['category2_id'];
        } elseif (!empty($product_info)) {
            $data['category2_id'] = $product_info['category_id'];
        } else {
            $data['category2_id'] = 0;
        }
        ...
        if (isset($this->request->post['category2'])) {
            ...
            if ($category_info) {
                $data['category2'] = $category_info['name'];
            } else {
                $data['category2'] = '';
            }
        } else {
