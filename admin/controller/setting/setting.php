...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['config_scheme_header'])) {
            $data['config_scheme_header'] = $this->request->post['config_scheme_header'];
        } else {
            $data['config_scheme_header'] = $this->config->get('config_scheme_header');
        }

        $data['schemes_header'] = [
            ['value' => 0, 'image' => '/catalog/view/theme/default/image/default.png'],
            ['value' => 1, 'image' => '/catalog/view/theme/default/image/default.png'],
        ];

        if (isset($this->request->post['config_scheme_home'])) {
            $data['config_scheme_home'] = $this->request->post['config_scheme_home'];
        } else {
            $data['config_scheme_home'] = $this->config->get('config_scheme_home');
        }

        $data['schemes_home'] = [
            ['value' => 0, 'image' => '/catalog/view/theme/default/image/default.png'],
            ['value' => 1, 'image' => '/catalog/view/theme/default/image/default.png'],
            ['value' => 2, 'image' => '/catalog/view/theme/default/image/default.png'],
        ];
