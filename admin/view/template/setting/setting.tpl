        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-scheme-header">Схема шапки</label>
                <div class="col-sm-10">
                  <?php foreach ($schemes_header as $scheme) { ?>
                  <label class="radio-inline">
                    <?php if ($scheme['value'] == $config_scheme_header) { ?>
                    <input type="radio" name="config_scheme_header" value="<?= $scheme['value'] ?>" checked="checked" />
                    <img src="<?php echo $scheme['image']; ?>"/>
                    <?php } else { ?>
                    <input type="radio" name="config_scheme_header" value="<?= $scheme['value'] ?>" />
                    <img src="<?php echo $scheme['image']; ?>"/>
                    <?php } ?>
                  </label>
                  <?php } ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-scheme-home">Схема главной</label>
                <div class="col-sm-10">
                  <?php foreach ($schemes_home as $scheme) { ?>
                  <label class="radio-inline">
                    <?php if ($scheme['value'] == $config_scheme_home) { ?>
                    <input type="radio" name="config_scheme_home" value="<?= $scheme['value'] ?>" checked="checked" />
                    <img src="<?php echo $scheme['image']; ?>"/>
                    <?php } else { ?>
                    <input type="radio" name="config_scheme_home" value="<?= $scheme['value'] ?>" />
                    <img src="<?php echo $scheme['image']; ?>"/>
                    <?php } ?>
                  </label>
                  <?php } ?>
