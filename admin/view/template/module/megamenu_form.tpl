  ...
  <div class="container-fluid">
	...
	<div class="form-group">
	  ...
	  <div class="tab-pane fade" id="tab-html_options">
			...
			<?php foreach ($languages as $language) { ?>
			<li><a href="#language_html<?php echo $language['language_id']; ?>" data-toggle="tab"> <?php echo $language['name']; ?></a></li>
			<?php } ?>
		  </ul>
		  <div class="tab-content">
			<?php foreach ($languages as $language) { ?>
        ...
        <div class="tab-pane fade" id="tab-link_options">
		  ...
		  <div class="tab-pane fade" id="tab-add_html">
			...
			<?php foreach ($languages as $language) { ?>
			<li><a href="#language_add_html<?php echo $language['language_id']; ?>" data-toggle="tab"> <?php echo $language['name']; ?></a></li>
			<?php } ?>
		  </ul>
		  <div class="tab-content">
