            ...
            <table class="table table-bordered table-hover">
              ...
              <tr>
                ...
                <td class="text-left"><?php if ($sort == 'p.model') { ?>
                  ...
                  <?php } ?></td>
                  -->
                <td class="text-right" width="175">Цена</td>
              ...
              <tr>
                ...
                <td class="text-right">
                  ...
                  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    <input type="text" placeholder="Цена" data-rate="<?= $product['currency']['value'] ?>" class="form-control" onchange="calculate(event)" value="<?php echo round($product['price'] / $product['currency']['value'] * $currentCurrency['value'], 3); ?>">
                ...
                <td class="text-left">
                  <select name="status" class="form-control" onchange="clickButton(event)">
                    <option value="0" <?php if($product['status'] == 'Отключено'): ?>selected<?php endif; ?>>Отключено</option>
                    <option value="1" <?php if($product['status'] == 'Включено'): ?>selected<?php endif; ?>>Включено</option>
                  </select>
                </td>
