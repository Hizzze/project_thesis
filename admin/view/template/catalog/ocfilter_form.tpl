		          ...
		          <table class="form">
		            <tr>
		              ...
		              <td>
		                ...
		                <input type="text" name="ocfilter_option_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo (isset($name[$language['language_id']]) ? $name[$language['language_id']]['name'] : ''); ?>" size="50" />&nbsp;<br />
		                <?php } ?>
		              </td>
		            </tr>
		            <tr>
		        ...
		        <div id="tab-other" class="tab-pane">
		          <table class="form">
		            <tr>
		              ...
		              <td>
		                <?php foreach ($languages as $language) { ?>
		                <input type="text" name="ocfilter_option_description[<?php echo $language['language_id']; ?>][postfix]" value="<?php echo (isset($name[$language['language_id']]) ? $name[$language['language_id']]['postfix'] : ''); ?>" size="10" />&nbsp;<br />
		                <?php } ?>
		              </td>
		            </tr>
		            <tr>
		              ...
		              <td>
		                <?php foreach ($languages as $language) { ?>
		                <textarea name="ocfilter_option_description[<?php echo $language['language_id']; ?>][description]" rows="3" cols="50" style="resize: none;"><?php echo (isset($name[$language['language_id']]) ? $name[$language['language_id']]['description'] : ''); ?></textarea>&nbsp;<br />
		                <?php } ?>
		              </td>
		            </tr>
		            <tr>
		          ...
		          <ul id="sortable">
		            ...
		            <li>
		              ...
		              <div class="fields">
		                ...
		                <?php foreach ($languages as $language) { ?>
		                <label><input type="text" class="value-name" name="ocfilter_option_value[update][<?php echo $value['value_id']; ?>][language][<?php echo $language['language_id']; ?>][name]" value="<?php echo (isset($value['language'][$language['language_id']]) ? $value['language'][$language['language_id']]['name'] : ''); ?>" size="80" />&nbsp;</label>
		                <?php } ?>
		              </div>
