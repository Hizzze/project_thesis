...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <?php if($product_link): ?>
        <a href="<?php echo $product_link; ?>" data-toggle="tooltip" class="btn btn-default">
          Перейти на товар
        </a>
        <?php endif; ?>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $text_form; ?> <?php if($product_id): ?>(id <?= $product_id ?>)<?php endif; ?></h3>
      </div>
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-set" data-toggle="tab"><?php echo $tab_sets;?></a></li>
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_title'] : ''; ?>" placeholder="<?php echo $seo_product_meta_title; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][meta_description]" rows="5" placeholder="<?php echo $seo_product_meta_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-keyword<?php echo $language['language_id']; ?>"><?php echo $entry_meta_keyword; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]" rows="5" placeholder="<?php echo $seo_product_meta_keywords; ?>" id="input-meta-keyword<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-upc"><span data-toggle="tooltip" title="ID товара, который будет подарком к текущемо товару">ID подарка</span></label>
                <div class="col-sm-10">
                  <input type="text" name="upc" value="<?php echo $upc; ?>" placeholder="ID подарка" id="input-upc" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <?php if($isbn): ?>
                  <div><?php echo $isbn; ?></div>
                  <?php endif; ?>
                  <input type="file" name="isbn" id="input-isbn" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mpn"><span data-toggle="tooltip" title="<?php echo $help_mpn; ?>">Промо-блок</span></label>
                <div class="col-sm-10">
                  <textarea name="mpn" placeholder="Промо-блок" id="input-mpn" class="form-control summernote"><?php echo $mpn; ?></textarea>
             ...
             -->
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="currency" id="input-currency" class="form-control">
                    ...
                    <?php if ($cur['default']) { ?>
                    <option value="<?php echo $cur['code']; ?>" <?php if($cur['code'] === $currency['code']) { ?>selected="selected"<?php } ?> data-rate="<?php echo $cur['value']; ?>"><?php echo $cur['title']; ?><b>(По-умолчанию)</b></option>
                    <?php } else { ?>
                    <option value="<?php echo $cur['code']; ?>" <?php if($cur['code'] === $currency['code']) { ?>selected="selected"<?php } ?> data-rate="<?php echo $cur['value']; ?>"><?php echo $cur['title']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" value="<?php echo number_format((float)$price / $currency['value'] * $currentCurrency['value'], 2, '.', ''); ?>" placeholder="<?php echo $entry_price; ?>" id="input-price" class="form-control" />
                  <span id="price-res"></span><?=$currentCurrency['code'] ?>
                </div>
              </div>
              <input type="hidden" name="price" value="<?php echo $price / $currency['value'] * $currentCurrency['value'] ?>" id="input-price-result" class="form-control" />
              <script>
                  function calculate(curValue, price) {
                      let defValue = <?=$currentCurrency['value'] ?>;
                      return parseFloat((price / defValue * curValue).toFixed(2));
                  }

                  $(document).ready(function() {
                      let curValue$ = $('#input-currency');
                      let resInput$ = $('#input-price-result');
                      let res$ = $('#price-res');
                      let priceInput$ = $('#input-price');
                      resInput$.val(calculate(+curValue$.find(':selected').attr('data-rate'), +priceInput$.val()));
                      res$.html(calculate(+curValue$.find(':selected').attr('data-rate'), +priceInput$.val()));

                      curValue$.on('change', function(e) {
                          resInput$.val(calculate(+curValue$.find(':selected').attr('data-rate'), +priceInput$.val()));
                          res$.html(calculate(+curValue$.find(':selected').attr('data-rate'), +priceInput$.val()));

                          var specialTds = $('#special tbody tr td:nth-child(3)').each(function(index, specialTd) {
                              var specialTd$ = $(specialTd);
                              var specialPercentage = specialTd$.find('input:first-child').val();
                              var productPrice = resInput$.val();
                              specialTd$.find('input:last-child').val(productPrice - (productPrice * specialPercentage / 100))
                          });
                      });
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-category2"><span data-toggle="tooltip" title="<?php echo $help_category2; ?>"><?php echo $entry_category2; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="category2" value="<?php echo $category2; ?>" placeholder="<?php echo 2; ?>" id="input-category" class="form-control" />
                  <input type="hidden" name="category2_id" value="<?php echo $category2_id; ?>" />
                </div>
              </div>
              ...
              <div class="table-responsive">
                <table id="special" class="table table-striped table-bordered table-hover">
                  ...
                  <tr id="special-row<?php echo $special_row; ?>">
                    ...
                    <td class="text-right">
                      <input type="number" name="product_special[<?php echo $special_row; ?>][price][percentage]" onchange="changeSpecialPercentage(this)" value="<?php echo $product_special['price'] * 100 / $price; ?>" placeholder="Процент" class="form-control" />
  ...
  <script type="text/javascript">
      <?php foreach ($languages as $language) { ?>
          $('[name="product_description[<?php echo $language['language_id']; ?>][name]"]').on('change, keydown, keyup', function(e) {
              var $keyword = $('[name="keyword"]');
              $keyword.val( slugify( this.value, { separator: '-' } ) );
          });
      <?php } ?>
  ...
  <script type="text/javascript"><!--
      ...
      // Category 2
      $('input[name=\'category2\']').autocomplete({
          'source': function(request, response) {
              $.ajax({
          ...
          'select': function(item) {
              ...
              $('input[name=\'category2\']').val(value);
              $('input[name=\'category2_id\']').val(item['value']);
          }
      });
  ...
  <script type="text/javascript"><!--
      ...
      <?php foreach ($languages as $language) { ?>
              html += '<div class="input-group"><span class="input-group-addon"></span><textarea name="product_attribute[' + attribute_row + '][product_attribute_description][<?php echo $language['language_id']; ?>][text]" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control"></textarea></div>';
          <?php } ?>
          html += '  </td>';
  ...
  <script type="text/javascript"><!--
    ...
    function changeSpecialPercentage(t) {
      var specialPercentage = $(t).val();
      var specialInput = $(t).parents('td').find('input:last-child');
      var productPrice = $('#input-price-result').val();

      specialInput.val(productPrice - (productPrice * specialPercentage / 100));
    }
      ...
      <?php foreach ($customer_groups as $customer_group) { ?>
          ...
          html += '  <td class="text-right"><input type="number" name="product_special[' + special_row + '][price][percentage]" onchange="changeSpecialPercentage(this)" value="" placeholder="Процент" class="form-control" /><input type="hidden" name="product_special[' + special_row + '][price]" value="" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>';
